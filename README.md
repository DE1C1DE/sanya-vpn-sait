...
Подключить домен и HTTPS на уже установленном сервере можно повторным запуском с параметрами:

```bash
sudo bash install.sh --domain vpn.example.com --admin-password 'пароль'
```
